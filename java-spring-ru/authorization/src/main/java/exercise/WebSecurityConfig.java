...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                // доступен аутентифицированным пользователям с полномочиями "USER" или "ADMIN"
                .antMatchers(GET,"/users/**").hasAnyAuthority(UserRole.USER.name(), UserRole.ADMIN.name())
                // Удалить пользователя может только аутентифицированный пользователь
                // с полномочиями "ADMIN"
