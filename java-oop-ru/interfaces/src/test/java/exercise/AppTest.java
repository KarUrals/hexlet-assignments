...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        char expected2 = 'e';
        int expected3 = 6;
        String expected4 = "edc";

        assertThat(text.toString()).isEqualTo(expected1);
        assertThat(text.charAt(1)).isEqualTo(expected2);
        assertThat(text.length()).isEqualTo(expected3);
        assertThat(text.subSequence(1, 4)).isEqualTo(expected4);
    }
    // END
}
